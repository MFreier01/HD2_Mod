...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event){
        ...
        ModBlockTagGenerator blackTagGenerator = generator.addProvider(event.includeServer(),
                new ModBlockTagGenerator(packOutput, lookupProvider, existingFileHelper));
        generator.addProvider(event.includeServer(), new ModItemTagGenerator(packOutput, lookupProvider, blackTagGenerator.contentsGetter(), existingFileHelper));
    }
